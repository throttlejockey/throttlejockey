...
class ControllerStartupSession extends Controller
{
    ...
    {
        if (isset($this->request->get['route']) && (strpos($this->request->get['route'], 'login') !== false || strpos($this->request->get['route'], 'dhlexpress_api') !== false)) {
            // Do nothing
        } else if (isset($this->request->get['route']) && substr($this->request->get['route'], 0, 4) == 'api/') {
