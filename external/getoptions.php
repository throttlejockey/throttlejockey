...
$query = $db->query("
        ...
        foreach ($product_option_data2 as $product => $options) {
            ...
            if ($isRequired) {
                ...
                print "$productIdStr Product: $product $endchar </br>";
                ...
                print "$productIdStr Product: $product -other</br>";
                print "ID: $productId<br/>";
            }
            ...
            if($options) {
                ...
                foreach ($options[0] as $option) {
                    ...
                    foreach ($option_values as $option_value) {
                        ...
                        print "      Sub Option: " . $option_value['name'] . " </br>"; 
                        if(SHOW_IDS) {
                        ...
                        print "        - [image] => " . $option_value['image'] . " </br>";
