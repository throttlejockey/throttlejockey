...
$_['help_charge_charges']				= 'Separate charge brackets by commas or new lines, and enter them in the format:<br /><br /><b>From - To = Cost / Per</b><br /><br />The "Per" setting is optional. For example, to charge $5.00 for orders $0-49.99, and beyond that charge $1.00 in shipping for every $10 of the total, you would enter:<br /><div class="text-left" style="margin: 10px">0-49.99 = 5.00<br />50-99999 = 1.00 / 10</div>You can leave out the "From" and "To" values if they would be 0 and 999999, respectively.';
...
$_['help_cumulative']					= 'Cumulative bracket charges mean that each successive bracket will be added together. For example, if you charge $5.00 for the $50 of an order, and $3.00 for each $50 thereafter, then an order that is $75 will charge $5.00 + $3.00 = $8.00';
?>