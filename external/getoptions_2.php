        ...
        foreach ($product_option_data2 as $product => $options) {
            ...
            if($options) {
                ...
                foreach ($options[0] as $option) {
                    ...
                    $fileContent .= "\r\n";
                    $fileContent .= "\r\n";
                    $fileContent .= "  - $option_idStr Option: $option_name $required \r\n";
                    ...
                    foreach ($option_values as $option_value) {
                        ...
                        $fileContent .= "\r\n";
                        $fileContent .= "     - Value: " . $option_value['name'] . "\r\n";
                        ...
                        if(SHOW_IDS) {
                            ...
                            $fileContent .= "        - [product_option_value_id] => " . $option_value['product_option_value_id'] . "\r\n";
                            $fileContent .= "        - [product_option_value_id] => " . $option_value['product_option_value_id'] . "\r\n";
                        ...
                        // $fileContent .= "        - [image] => " . $imgnm . "\r\n";
                        // // $fileContent .= "        - [quantity] => " . $option_value['quantity'] . "\r\n";
                        // // $fileContent .= "        - [subtract] => " . $option_value['subtract'] . "\r\n";
                        // $fileContent .= "        - [price] => " . $option_value['price'] . "\r\n";
                        // // $fileContent .= "        - [price_prefix] => " . $option_value['price_prefix'] . "\r\n";
                        // // $fileContent .= "        - [weight] => " . $option_value['weight'] . "\r\n";
                        // // $fileContent .= "        - [weight_prefix] => " . $option_value['weight_prefix'] . "\r\n";
            ...
            $file_name = preg_replace( '/[^a-z0-9]+/', '-', strtolower( $product ) );
            $output_file = DIR_LOGS . "lists/products/$file_name.txt";
            if (file_exists( $output_file )) { unlink( $output_file ); }
            file_put_contents( $output_file  , "$fileContent" ); //print_r($data, 1));
            // file_put_contents( $output_file  , "OPTION LIST \r\nLast Update: $currDate\r\n\r\n\r\n$fileContent" ); //print_r($data, 1));
            ////
