			...
			<div class="pull-right">
				...
				<?php if (!empty($buttons)) { ?>
					<?php foreach ($buttons as $button) { ?>
						<a id="button-<?php echo $button['id']; ?>" data-toggle="tooltip" title="<?php echo $button['title']; ?>" class="btn top-buttons <?php echo $button['class']; ?>"><i class="fa fa-<?php echo $button['icon']; ?>"></i></a>
					<?php } ?>
				<?php } ?>
					
				<button id="button-save" type="submit" form="form-<?php echo $extension_id; ?>" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i></button>
				<button id="button-apply" onclick="$('#apply').attr('value', '1'); $('#form-<?php echo $extension_id; ?>').submit();" form="form-<?php echo $extension_id; ?>" data-toggle="tooltip" title="<?php echo $button_apply; ?>" class="btn btn-success"><i class="fa fa-check"></i></button>
        		<a id="button-help" href="<?php echo $maincancel; ?>" data-toggle="tooltip" title="<?php echo $button_cancel; ?>" class="btn btn-default"><i class="fa fa-reply"></i></a>
    		</div>
