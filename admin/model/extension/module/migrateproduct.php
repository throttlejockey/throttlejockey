...
while($result = $query->fetch_assoc())
{
	...
	$image             = normalizeString($result['image']);//    $result['image'];
...
function normalizeString ($str = '')
{
    ...
    $lastDot = strrpos($str, ".");
    $str = str_replace(".", "_", substr($str, 0, $lastDot)) . substr($str, $lastDot);
    $str = strip_tags($str); 
    $str = preg_replace('/[\r\n\t ]+/', ' ', $str);
    ...
    // ... Moved folders in OC3. 
    $str = str_replace("data/", "catalog/", $str);
