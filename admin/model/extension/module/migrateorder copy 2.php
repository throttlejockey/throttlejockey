...
// Get Order Records
$o = 0;
$sql = "SELECT * FROM `" . $db_prefix1 . "order`";
$query = mysqli_query($con1,$sql);
...
{ 
    $oh = 0;
    $sql = "SELECT * FROM `" . $db_prefix1 . "order_history`";
    $query = mysqli_query($con1,$sql);
...
{ 
    $oh = 0;
    $sql = "SELECT * FROM `" . $db_prefix1 . "order_option`";
    $query = mysqli_query($con1,$sql);
...
{ 
    $oh = 0;
    $sql = "SELECT * FROM `" . $db_prefix1 . "order_product`";
    $query = mysqli_query($con1,$sql);
...
{ 
    $oh = 0;
    $sql = "SELECT * FROM `" . $db_prefix1 . "order_recurring`";
    $query = mysqli_query($con1,$sql);
...
{ 
    ...
    {
	    $oh = 0;
        $sql = "SELECT * FROM `" . $db_prefix1 . "order_shipment`";
        $query = mysqli_query($con1,$sql);
...
{ 
    $oh = 0;
    $sql = "SELECT * FROM `" . $db_prefix1 . "order_total`";
    $query = mysqli_query($con1,$sql);
...
{ 
    $oh = 0;
    $sql = "SELECT * FROM `" . $db_prefix1 . "order_voucher`";
    $query = mysqli_query($con1,$sql);
...
{ 
    $pa = 0;
    $sql = "SELECT * FROM `" . $db_prefix1 . "return`";
    $query = mysqli_query($con1,$sql);
