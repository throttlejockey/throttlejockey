<?php
    class ModelExtensionModuleDiscountsProTabCategories extends ModelExtensionModuleDiscountsPro
    {
        public function __construct($registry) {
            parent::__construct($registry);
            $this->load->language($this->real_extension_type.'/discounts_pro_tab_categories');
        }        
        ...
        public function get_fields() {
            ...
            $fields = array(
                array(
                    'label' => $this->language->get('categories_status'),
                    'type' => 'boolean',
                ...
                array(
                    ...
                    'value' => $this->config->get('category'),
                    'model_row' => array(
                        array(
                            'type' => 'boolean',
                            'name' => 'status'
                        ...
                        array(
                            'type' => 'select',
                            'options' => $this->get_categories_select(),
                            'name' => 'category_id'
                        ),
                        array(
                            'type' => 'select',
                ...
                array(
                    'type' => 'legend',
                    'text' => $this->language->get('discount_category_table')
                ),
                array(
                    'type' => 'table',
                    'theads' => $this->get_table_orders(),
                    'data' => $this->get_orders_with_discount('category'),
                )
