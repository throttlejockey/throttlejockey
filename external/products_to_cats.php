...
if ( file_exists( $root . 'catalog/model/catalog/product.php' ) ) {
    ///library/cart/user.php')) {
...
$customer = new Cart\Customer($registry);
        ...
        $query = $db->query("SELECT * FROM oc_product op;");
        ...
        foreach ($query->rows as $result) {
            ...
            if($prodcategories) {              
                foreach($prodcategories as $prodcategory) {
                    ...
                    $catArray[$prodcategory['category_id']] = $pid;
                }
                // $this->data['cats'] = $cats;
             }
